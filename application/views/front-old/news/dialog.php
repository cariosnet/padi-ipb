	...
	<div class="container">
		...
		<div class="content_wrap">
			<div class="content_canvas">
				...
				<div class="breadCrumb module">
					<ul>
						...
						<li><a href="<?php echo site_url('news/fokus')?>">Wawancara</a></li>
					</ul>
				</div>
				<!-- End of BreadCrumbs -->
				...
				<div class="content_action">
					<!-- FaceBook -->
					<div style="float: left; margin-right: 5px;" class="fb-like" data-href="<?php echo site_url('news/dialog/'.$news->NEWS_ID.'/'.$news->ALIAS)?>" data-send="true" data-layout="button_count" data-width="100" data-show-faces="true" data-action="recommend"></div>
					
					<!-- Twitter  -->
					<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo site_url('news/dialog/'.$news->NEWS_ID.'/'.$news->ALIAS)?>" data-via="KlikPositif" data-lang="id" data-hashtags="KlikPositif">Tweet</a>
					<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
			...
			<div class="comment_canvas">
				<div style="margin: 5px;" class="fb-comments" data-href="<?php echo site_url('news/dialog/'.$news->NEWS_ID.'/'.$news->ALIAS)?>" data-width="627" data-num-posts="6"></div>
			</div>
		</div>
