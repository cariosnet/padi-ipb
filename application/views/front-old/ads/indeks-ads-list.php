	...
	<script type="text/javascript">
    	...
    	function sendFilterRequest(){
    	    ...
    	    jQuery.ajax({
    	        url: "<?php echo site_url('ads/ajax_filter')?>", 
			...
			<div class="content_canvas">
				...
				<div class="breadCrumb module">
					<ul>
						...
						<li><a href="javascript:void(0)">Iklan Baris</a></li>
					</ul>
				</div>
				<!-- End of BreadCrumbs -->
				
				<div class="content_title">Iklan Baris</div>
				<div class="content_subtitle" style="padding: 0px; margin-bottom: 10px;"></div>
				
				<div class="news_content" style="min-height: 350px;">
					<form id="ajax_filter" onsubmit="sendFilterRequest();return false;" action="<?php echo site_url('indeks/ajax_filter_special')?>" method="post">
						Kata Kunci: <input type="text" name="ads_title" style="width: 175px;" value="" />
						Kategori: <select name="ads_cat" class='chosen-select input-block-level'>
