<!-- BootStrap Datepicker -->
	...
	<script type="text/javascript">
    	...
    	function sendFilterRequest(){
    	    ...
    	    jQuery.ajax({
    	        url: "<?php echo site_url('m/indeks/ajax_filter_special/dialog')?>", 
...
<div class="container">
	<div class="headline_wrap" style="min-height: 50px;">
		<div class="breadcrumbs">
			&raquo; Home&nbsp;
			&raquo; <a href="<?php echo site_url('m/indeks/dialog')?>">Indeks Wawancara</a>&nbsp;
		</div>
		<div class="news_properties">
			<div class="content_title">Indeks Wawancara</div>
		</div>
	</div>
				
	<div class="news_content">
		<form id="ajax_filter" action="<?php echo site_url('m/indeks/ajax_filter_special/dialog')?>" method="post">
			<table>
				<tr>
					<td>Tanggal</td>
