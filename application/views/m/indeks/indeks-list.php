<!-- BootStrap Datepicker -->
	...
	<script type="text/javascript">
    	...
    	function sendFilterRequest(){
    	    ...
    	    jQuery.ajax({
    	        url: "<?php echo site_url('m/indeks/ajax_filter')?>", 
...
<div class="container">
	<div class="headline_wrap" style="min-height: 50px;">
		<div class="breadcrumbs">
			&raquo; Home&nbsp;
			&raquo; <a href="<?php echo site_url('m/indeks')?>">Indeks</a>&nbsp;
		</div>
	...
	<div class="news_content">
		<form id="ajax_filter" action="<?php echo site_url('m/indeks/ajax_filter')?>" method="post">
			<table>
				<tr>
					<td>Tanggal</td>
				...
				<tr>
					<td width="60px">Kanal</td>
					<td>
						<select name="cat" id="kanal" onblur="sendFilterRequest();">
				...
				<tr>
					<td></td>
					<td><a href="javascript:void(0)" onclick="sendFilterRequest();" class="uibutton">Lihat Indeks</a></td>
				</tr>
			</table>
		</form>
