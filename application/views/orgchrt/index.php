<?php 
	...
	mysql_select_db("web_beta") or die(mysql_error()); 
 
	// Select accounts
	$response = mysql_query("SELECT id as record_id, parentid, title, description, photo, itemtype FROM accounts") or die(mysql_error()); 
		...
		function getContactTemplate() {
			...
			var itemTemplate = jQuery(
			  '<div class="bp-item bp-corner-all bt-item-frame">'
				...
				+ '<div name="description" class="bp-item" style="top: 25px; left: 56px; width: 162px; height: 36px; font-size: 12px;"></div>'
