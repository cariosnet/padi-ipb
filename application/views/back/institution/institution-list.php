			<script type="text/javascript">
		    	...
		    	function deleteRow(id){
					...
					window.location = "<?php echo base_url().'backoffice/institution/delete/'?>"+id;
				}
		    </script>
		    <style>
			...
			<div class="page-header">
				...
				<div class="pull-right">
					<ul class="bread">
						...
						<li><a href="<?php echo site_url('backoffice/institution')?>">Institution</a><span class="divider">/</span></li>
						<li class='active'>Daftar Institusi</li>
					</ul>
				</div>
			</div>
