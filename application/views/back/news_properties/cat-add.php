			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Tambah Kategori</h4>
				</div>
							...
							<div class="box-body box-body-nopadding">
								<form action="<?php echo site_url('backoffice/news_properties/cat/'.$cat_type.'/submit') ?>" class="form-horizontal form-bordered form-validate" method="post" id="aa">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" onkeyup="setAlias(this);" onblur="setAlias(this);" name="cat_name" class="input-xlarge" data-rule-required="true">
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">Alias</label>
										<div class="controls">
											<input type="text" id="alias" name="cat_alias" class="input-xlarge" data-rule-required="true">
										</div>
									</div>
<!-- 									<div class="control-group"> -->
<!-- 										<label for="textfield" class="control-label">Warna</label> -->
<!-- 										<div class="controls"> -->
<!-- 											<input type="text" name="color" class="input-mini colorpick" > -->
...
<!-- 									</div> -->
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="cat_order" class="input-mini" data-rule-integer="true" data-rule-required="true" placeholder="Angka..">
										...
										<div class="controls">
											<select name="parent" class='chosen-select input-block-level'>
												...
												<?php foreach ($listCat->result() as $row): ?>
													...
													<?php foreach ($this->X_News_Category_Model->getListCat($row->ID)->result() as $row2): ?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="meta_key" class="span12" data-rule-required="true">
										</div>
									</div>
