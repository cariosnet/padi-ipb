			...
			<script type="text/javascript">
				...
				$(window).bind('beforeunload', function(e){
					if(checkCoords()){
						$('#cropUnLoad').val('Crop');					
						$.ajax({
					        url		: '<?php echo site_url('backoffice/fokus/croping/'.$row->NEWS_ID)?>', 
		    	...
		    	function cancel(){
					...
					window.location = "<?php echo base_url().'backoffice/news/fokus/'?>"; 
				}
			...
			<div class="container-fluid" id="content-area">
				...
				<form enctype="multipart/form-data" onsubmit="return checkCoords();" id="cropFrom" action="<?php echo site_url('backoffice/fokus/croping/'.$row->NEWS_ID)?>" class="form-horizontal form-bordered form-validate" method="post">
