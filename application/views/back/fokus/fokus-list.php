			<script type="text/javascript">
		    	$(document).ready(function(){
		    		...
		    		$("#submenu-artikel-list").addClass('active');
		        });

		    	function deleteRow(id){
					jQuery.facebox.close();
					window.location = "<?php echo base_url().'backoffice/fokus/delete/'?>"+id; 
				}
		    </script>
		    <style>
			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i> Daftar Fokus</h4>
				</div>
				<div class="pull-right">
					<ul class="bread">
						...
						<li class='active'>Daftar Fokus</li>
					</ul>
				</div>
			</div>
													...
													<div class="box-body box-body-nopadding">
														<div class="highlight-toolbar">
															<div class="pull-left"><div class="btn-toolbar">
																<div class="btn-group">
																	<a href="<?php echo site_url('backoffice/fokus/create')?>" class="button button-basic" rel="tooltip" title="Tambah Fokus"><i class="icon-plus"></i> Tambah Fokus</a>
																</div>
															</div></div>
														</div>
																...
																<tr style="text-align: center;">
																	...
																	<td>
																		<div class="btn-toolbar" style="margin: 0; padding: 0;">
																			<div class="btn-group">
																				<a href="<?php echo site_url('backoffice/fokus/edit/'.$row->NEWS_ID)?>" class='button button-basic button-small' rel="tooltip" title="Ubah"><i class="icon-edit"></i></a>
