			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Ubah Pengguna</h4>
				</div>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-head">
								<i class="icon-edit"></i>
								<span>Data Login Pengguna</span>
							</div>
							<div class="box-body box-body-nopadding">
									<div class="control-group">
										<label for="textfield" class="control-label">Username</label>
										<div class="controls">
											<input type="text" name="username" class="input-xlarge" data-rule-required="true" value="<?php echo $user->USERNAME?>">
									...
									<div class="control-group">
										...
										<div class="controls">
											<label class='radio-uniformed'>
												<input type="radio" name="status" value="A" class='uniform-me' data-rule-required="true" <?php if($user->STATUS == 'A')echo 'checked="checked"';?>> Aktif
											</label>
											<label class='radio-uniformed'>
												<input type="radio" name="status" value="N" class='uniform-me' data-rule-required="true" <?php if($user->STATUS == 'N')echo 'checked="checked"';?>> Tidak Aktif
											</label>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<label class='radio-uniformed'>
												<input type="radio" name="role" value="1" class='uniform-me' data-rule-required="true" <?php if($user->ROLE == '1')echo 'checked="checked"';?>> Super User (SU)
											</label>
											<label class='radio-uniformed'>
												<input type="radio" name="role" value="2" class='uniform-me' data-rule-required="true" <?php if($user->ROLE == '2')echo 'checked="checked"';?>> Redaktur
											</label>
											<label class='radio-uniformed'>
												<input type="radio" name="role" value="3" class='uniform-me' data-rule-required="true" <?php if($user->ROLE == '3')echo 'checked="checked"';?>> Marketing
											</label>
										</div>
									</div>
