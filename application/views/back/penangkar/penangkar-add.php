            ...
            <div class="box">
                ...
                <div class="box-body box-body-nopadding">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="lembaga" class='chosen-select input-block-level'>
                                ...
                                <?php foreach ($listLembaga->result() as $parent):?>
                                <option value="<?php echo $parent->ID?>"><?php echo $parent->INSTITUTION_NAME?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="kota" data-rule-required="true" class="input-xlarge span6">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">Provinsi Tujuan</label>
                        <div class="controls">
                            <input type="text" name="provinsi" data-rule-required="true" class="input-xlarge span6">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">Volume 3S</label>
                        <div class="controls">
                            <input type="number" name="3s" data-rule-required="true" class="input-xlarge span6">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">Volume 4S</label>
                        <div class="controls">
                            <input type="number" name="4s" data-rule-required="true" class="input-xlarge span6">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="bootstrap-timepicker">
                                <input type="text" name="send_date" id="textfield" class="input-xlarge datepick" value="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy">
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="producer" data-rule-required="true" class="input-xlarge span6">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">Dikirim Oleh</label>
                        <div class="controls">
                            <input type="text" name="sender" data-rule-required="false" class="input-xlarge span6">
                        </div>
                    </div>
