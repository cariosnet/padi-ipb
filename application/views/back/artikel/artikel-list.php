			<script type="text/javascript">
		    	$(document).ready(function(){
		    		...
		    		$("#submenu-artikel-list<?php echo $idx;?>").addClass('active');
		    		...
		    		$('#newsTable').dataTable({
		                ...
		                sAjaxSource: "<?php echo site_url('backoffice/artikel/ajax_news_listing/'.$idx) ?>",
		                aoColumns: [
		    	...
		    	function deleteRow(id){
					...
					window.location = "<?php echo base_url().'backoffice/artikel/delete/'.$idx.'/'?>"+id; 
				}
		    </script>
		    <style>
			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i> Daftar <?php echo getArtikelName($idx);?></h4>
				</div>
				<div class="pull-right">
					<ul class="bread">
						...
						<li class='active'>Daftar <?php echo getArtikelName($idx);?></li>
					</ul>
				</div>
			</div>
						...
						<div class="span12">
							<div class="box">
								<div class="box-head">
									...
									<span>Daftar <?php echo getArtikelName($idx);?></span>
								</div>
								<div class="box-body box-body-nopadding">
									<div class="highlight-toolbar">
										<div class="pull-left"><div class="btn-toolbar">
											<div class="btn-group">
												<a href="<?php echo site_url('backoffice/artikel/create/'.$idx)?>" class="button button-basic" rel="tooltip" title="Tambah Fokus"><i class="icon-pencil"></i> Buat Baru</a>
											</div>
										</div></div>
									</div>
