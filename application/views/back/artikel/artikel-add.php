...
// 		    	    });
		    	...
		    	function cancel(){
					...
					window.location = "<?php echo base_url().'backoffice/news/create/'.$idx?>"; 
				}
			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i><?php echo getArtikelName($idx)?> Baru</h4>
				</div>
				<div class="pull-right">
					<ul class="bread">
						...
						<li class='active'>Buat <?php echo getArtikelName($idx);?></li>
					</ul>
				</div>
			</div>
						...
						<div class="box">
							...
							<div class="box-body box-body-nopadding">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="news_picture_caption" class="input-xlarge span12" >
										</div>
									</div>
<!-- 									<div class="control-group"> -->
