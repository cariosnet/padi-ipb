			...
			<script type="text/javascript">
				$(document).ready(function(){
		    		...
		    		$("#submenu-artikel-create").addClass('active');
				...
				$(window).bind('beforeunload', function(e){
					if(checkCoords()){
						$('#cropUnLoad').val('Crop');					
						$.ajax({
					        url		: '<?php echo site_url('backoffice/artikel/croping/'.$row->NEWS_ID)?>', 
		    	...
		    	function cancel(){
					...
					window.location = "<?php echo base_url().'backoffice/artikel/create/'?>"; 
				}
			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Artikel Baru</h4>
				</div>
				<div class="pull-right">
					<ul class="bread">
						<li><a href="<?php echo site_url('backoffice')?>">Home</a><span class="divider">/</span></li>
						<li><a href="<?php echo site_url('backoffice/news')?>">Artikel</a><span class="divider">/</span></li>
			...
			<div class="container-fluid" id="content-area">
				...
				<form enctype="multipart/form-data" onsubmit="return checkCoords();" id="cropFrom" action="<?php echo site_url('backoffice/artikel/croping/'.$row->NEWS_ID)?>" class="form-horizontal form-bordered form-validate" method="post">
