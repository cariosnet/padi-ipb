				...
				<li id="menu-ads">
					...
					<ul class="subnav">
						...
						<li id="submenu-adscat-list"><a href="<?php echo site_url('backoffice/ads_properties')?>">Kategori Iklan</a></li>
                                 ...
                                 <li id="menu-potogal">
                                        <a href="#"><i class="icon-thumbs-up icon-white"></i><span>Galeri Foto</span></a>
                                        <ul class="subnav">
						<li id="submenu-kategfoto-list"><a href="<?php echo site_url('backoffice/potogal/kateg')?>">Daftar Kategori Foto</a></li>
