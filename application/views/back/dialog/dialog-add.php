			...
			<script type="text/javascript">
		    	...
		    	function cancel(){
					...
					window.location = "<?php echo base_url().'backoffice/dialog/create/'?>"; 
				}
			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Wawancara Baru</h4>
				</div>
				<div class="pull-right">
					<ul class="bread">
						...
						<li class='active'>Tambah Fokus</li>
					</ul>
				</div>
			</div>
			...
			<div class="container-fluid" id="content-area">
				...
				<form enctype="multipart/form-data" action="<?php echo site_url('backoffice/dialog/submit') ?>" class="form-horizontal form-bordered form-validate" method="post" id="aa">
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-head">
								<i class="icon-edit"></i>
								<span>Form Wawancara Baru</span>
							</div>
							<div class="box-body box-body-nopadding">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="news_subtitle" class="input-xlarge span12" data-rule-required="true">
										</div>
									</div>
									<div class="control-group">
						...
						<div class="box">
							...
							<div class="box-body box-body-nopadding">
									...
									<div class="form-actions">
										...
										<a href="javascript:void();" class="button button-basic" onclick="confirmPopUp('cancel();', 'Peringatan..', 'Anda yakin ingin membatalkan pembuatan wawancara ??', 'Ya', 'Tidak');">Batal</a>
									</div>
