...
<div class="container-fluid" id="content-area">
    ...
    <div class="row-fluid">
        <form action="<?php echo site_url('backoffice/wilayah/submit') ?>" class="form-horizontal form-bordered form-validate" method="post" id="aa">
        <div class="span6">
            <div class="box">
                <div class="box-head">
                    <i class="icon-edit"></i>
                    <span>Form Wilayah Baru</span>
                </div>
                <div class="box-body box-body-nopadding">
                    <div class="control-group">
                        <label for="textfield" class="control-label">Nama Wilayah</label>
                        <div class="controls">
                            <input type="text" id="wilayah-name" name="name" class="input-xlarge span12" data-rule-required="true">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">Latitude</label>
                        <div class="controls">
                            <input type="text" name="lat" id="lat" readonly class="input-xlarge span12" data-rule-required="true">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">Longitude</label>
                        <div class="controls">
                            <input type="text" name="lng" id="lng" readonly class="input-xlarge span12" data-rule-required="true">
                        </div>
                    </div>
