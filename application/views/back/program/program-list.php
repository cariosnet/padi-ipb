			<script type="text/javascript">
		    	...
		    	function deleteRow(id){
					...
					window.location = "<?php echo base_url().'backoffice/program/delete/'?>"+id; 
				}
		    </script>
		    <style>
			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i> Daftar Aplikasi Terkait</h4>
				</div>
				<div class="pull-right">
					<ul class="bread">
						...
						<li class='active'>Daftar Aplikasi Terkait</li>
					</ul>
				</div>
			</div>
											...
											<div class="span12">
												<div class="box">
													<div class="box-head">
														...
														<span>Daftar Aplikasi Terkait</span>
													</div>
													<div class="box-body box-body-nopadding">
														<div class="highlight-toolbar">
															<div class="pull-left"><div class="btn-toolbar">
																<div class="btn-group">
																	<a href="<?php echo site_url('backoffice/program/create')?>" class="button button-basic" rel="tooltip" title="Tambah Aplikasi Terkait"><i class="icon-plus"></i> Tambah Aplikasi Terkait</a>
																</div>
															</div></div>
														</div>
																...
																<tr style="text-align: center;">
																	...
																	<td>
																		<div class="btn-toolbar" style="margin: 0; padding: 0;">
																			<div class="btn-group">
																				<a href="<?php echo site_url('backoffice/program/edit/'.$row->ID)?>" class='button button-basic button-small' rel="tooltip" title="Ubah"><i class="icon-edit"></i></a>
