			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Ubah Regulasi</h4>
				</div>
				<div class="pull-right">
					<ul class="bread">
						...
						<li class='active'>Ubah Regulasi</li>
					</ul>
				</div>
			</div>
						...
						<div class="box">
							...
							<div class="box-body box-body-nopadding">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="nomor" class="input-large" value="<?php echo $row->NOMOR;?>" data-rule-required="true">
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">Tahun</label>
										<div class="controls">
											<input type="text" value="<?php echo $row->TAHUN;?>" name="tahun" class="input-mini" data-rule-integer="true" data-rule-required="true" placeholder="Tahun..">
										</div>
									</div>
									<div class="control-group">
