            ...
            <div class="box">
                ...
                <div class="box-body box-body-nopadding">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="barang" data-rule-required="true" class="input-xlarge span6">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">BS</label>
                        <div class="controls">
                            <input type="number" name="bs" data-rule-required="true" class="input-xlarge span6">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">FS</label>
                        <div class="controls">
                            <input type="number" name="fs" data-rule-required="true" class="input-xlarge span6">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">SS</label>
                        <div class="controls">
                            <input type="number" name="ss" data-rule-required="true" class="input-xlarge span6">
                        </div>
                    </div>
