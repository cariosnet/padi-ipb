			<script type="text/javascript">
		    	...
		    	function deleteRow(id){
					...
					window.location = "<?php echo base_url().'backoffice/produk/delete/'?>"+id; 
				}
		    </script>
		    <style>
			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i> Daftar Produk</h4>
				</div>
													...
													<div class="box-body box-body-nopadding">
														<div class="highlight-toolbar">
															<div class="pull-left"><div class="btn-toolbar">
																<div class="btn-group">
																	<a href="<?php echo site_url('backoffice/produk/create')?>" class="button button-basic" rel="tooltip" title="Tambah Produk"><i class="icon-plus"></i> Tambah Produk</a>
																</div>
															</div></div>
														</div>
														<table class="table table-nomargin table-bordered dataTable table-striped table-hover my-custom">
															...
															?>
																<tr style="text-align: center;">
																	...
																	<td><a target="_blank" href="<?php echo site_url('produk/detail/'.$row->ID.'/'.$row->ALIAS)?>"><?php echo $row->TITLE?></a></td>
																	...
																	<td>
																		<div class="btn-toolbar" style="margin: 0; padding: 0;">
																			<div class="btn-group">
																				<a href="<?php echo site_url('backoffice/produk/edit/'.$row->ID)?>" class='button button-basic button-small' rel="tooltip" title="Ubah"><i class="icon-edit"></i></a>
