			...
			$(document).ready(function(){
		    	...
		    	function deleteRow(id){
					...
					window.location = "<?php echo base_url().'backoffice/potogal/delete/'?>"+id; 
				}
		    </script>
		    <style>
			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i> Daftar Foto Galeri</h4>
				</div>
				<div class="pull-right">
					<ul class="bread">
						<li><a href="<?php echo site_url('backoffice')?>">Home</a><span class="divider">/</span></li>
						<li class='active'>Daftar Foto Galeri</li>
					</ul>
				</div>
			</div>
													...
													<div class="box-body box-body-nopadding">
														<div class="highlight-toolbar">
															<div class="pull-left"><div class="btn-toolbar">
																<div class="btn-group">
																	<a href="<?php echo site_url('backoffice/potogal/create')?>" class="button button-basic" rel="tooltip" title="Tambah Foto"><i class="icon-plus"></i> Tambah Foto</a>
																</div>
															</div></div>
														</div>
														<table class="table table-nomargin table-bordered dataTable table-striped table-hover my-custom">
															...
															?>
																<tr style="text-align: center;">
																	...
																	<td style="text-align: center;"><?php echo $row->TITLE_KAT?></td>
																	...
																	<td>
																		<div class="btn-toolbar" style="margin: 0; padding: 0;">
																			<div class="btn-group">
																				<a href="<?php echo site_url('backoffice/potogal/edit/'.$row->ID)?>" class='button button-basic button-small' rel="tooltip" title="Ubah"><i class="icon-edit"></i></a>
