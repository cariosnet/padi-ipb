			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Foto Baru</h4>
				</div>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-head">
								<i class="icon-edit"></i>
								<span>Form Add Foto Baru</span>
							</div>
							<div class="box-body box-body-nopadding">
									<div class="control-group">
										<label for="textfield" class="control-label">Judul Foto</label>
										<div class="controls">
											<input type="text" name="title" class="input-xlarge span12">
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<div class="bootstrap-timepicker">
												<input type="text" name="poto_date" id="textfield" class="input-small datepick" value="<?php echo date("d-m-Y");?>" data-date-format="dd-mm-yyyy">
