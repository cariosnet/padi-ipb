			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Kategori Link Edit</h4>
				</div>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-head">
								<i class="icon-edit"></i>
								<span>Form Kategori Link Edit</span>
							</div>
							<div class="box-body box-body-nopadding">
									<div class="control-group">
										<label for="textfield" class="control-label">Nama Kategori</label>
										<div class="controls">
											<input type="text" value="<?php echo $link->nama_kategori;?>" name="nama_kategori" class="input-xlarge span12" data-rule-required="true">
