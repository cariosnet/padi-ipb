			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Link Baru</h4>
				</div>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-head">
								<i class="icon-edit"></i>
								<span>Form Link Baru</span>
							</div>
							<div class="box-body box-body-nopadding">
									<div class="control-group">
										<label for="textfield" class="control-label">Nama</label>
										<div class="controls">
											<input type="text" name="nama" class="input-xlarge span12" data-rule-required="true">
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="alias" name="ref_url" placeholder="http://link.com" class="input-xlarge span12" data-rule-required="true">
										</div>
									</div>
