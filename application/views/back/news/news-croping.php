			...
			<script type="text/javascript">
				...
				$(window).bind('beforeunload', function(e){
					if(checkCoords()){
						$('#cropUnLoad').val('Crop');					
						$.ajax({
					        url		: '<?php echo site_url('backoffice/news/croping/'.$row->NEWS_ID)?>', 
			...
			<div class="container-fluid" id="content-area">
				...
				<form enctype="multipart/form-data" onsubmit="return checkCoords();" id="cropFrom" action="<?php echo site_url('backoffice/news/croping/'.$row->NEWS_ID)?>" class="form-horizontal form-bordered form-validate" method="post">
