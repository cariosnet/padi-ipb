			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Agenda Baru</h4>
				</div>
						...
						<div class="box">
							...
							<div class="box-body box-body-nopadding">
									...
									<div class="form-actions">
										...
										<a href="javascript:void();" class="button button-basic" onclick="confirmPopUp('cancel();', 'Peringatan..', 'Anda yakin ingin membatalkan pembuatan Agenda ??', 'Ya', 'Tidak');">Batal</a>
									</div>
