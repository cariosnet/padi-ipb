			...
			<script type="text/javascript">
				...
				$(window).bind('beforeunload', function(e){
					if(checkCoords()){
						$('#cropUnLoad').val('Crop');					
						$.ajax({
					        url		: '<?php echo site_url('backoffice/ads/croping/'.$row->ADS_ID)?>', 
		    	...
		    	function cancel(){
					...
					window.location = "<?php echo base_url().'backoffice/ads/create/'?>"; 
				}
			...
			<div class="page-header">
				<div class="pull-left">
					<h4><i class="icon-home"></i>Crop Gambar</h4>
				</div>
			...
			<div class="container-fluid" id="content-area">
				...
				<form enctype="multipart/form-data" onsubmit="return checkCoords();" id="cropFrom" action="<?php echo site_url('backoffice/ads/croping/'.$row->ADS_ID)?>" class="form-horizontal form-bordered form-validate" method="post">
							...
							<div class="box-body box-body-nopadding">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="hidden" name="img" value="<?php echo $row->ADS_PICTURE?>" />
											
						        			<img alt="<?php echo $row->ADS_TITLE;?>" id="cropbox" src="<?php echo $this->config->item('img_path').'ads/'.$row->ADS_PICTURE; ?>" /><br />
										</div>
									</div>
